                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-3">
                    {transactions.length === 0 ? (
                        ...
                        transactions.map((t) => (
                            <div
                                key={t.id}
                                className="flex items-center justify-between p-4 bg-[#1e293b]/40 rounded-xl hover:bg-[#1e293b]/60 transition-colors border border-transparent hover:border-[#1e222d] group cursor-pointer"
                            ...
                            >
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <button
                                        ...
                                        className="hidden group-hover:flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium transition-all bg-gray-500/10 text-gray-300 hover:bg-gray-500/20"
                                    >
