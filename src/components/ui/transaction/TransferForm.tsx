        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
            ...
            <div>
                ...
                <input
                    ...
                    className="w-full bg-[#1e293b] border border-[#1e222d] text-white px-4 py-3 rounded-lg text-sm"
                />
                {isIbanLoading && <p className="text-xs text-gray-400 mt-2 animate-pulse">Kontrol ediliyor...</p>}
                {recipientName && (
            ...
            <div className="flex gap-3 pt-2">
                <button type="button" onClick={onClose}
                        className="flex-1 bg-[#1e293b] hover:bg-[#334155] text-white px-6 py-3 rounded-lg text-sm">
                    İptal
                </button>
                <button
                    type="submit"
                ...
                >
                    {isLoading ? <RefreshCw className="animate-spin w-4 h-4"/> : <><Send className="w-4 h-4"/> Devam
                        Et</>}
                </button>
            </div>
        </form>
